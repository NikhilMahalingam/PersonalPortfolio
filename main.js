...
tl.fromTo(".text-box p1", {opacity: 0}, {opacity: 1})
tl.fromTo(".text-box h1", {opacity: 0}, {opacity: 1})
tl.fromTo(".text-box h2", {opacity: 0}, {opacity: 1})
tl.fromTo(".text-box p2", {opacity: 0}, {opacity: 1})
